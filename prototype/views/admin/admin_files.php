...
<body>
    ...
    <div class="main-container">
        ...
        <main class="content">
            <div class="title">
                <span class="title-panel"><?php echo $user_details['name']?> <?php echo $user_details['1surname']?> <?php echo $user_details['2surname']?></span>
            </div>

            <div class="files-box">
                <div class="title">
                    <span class="title-panel">Archivos</span>
                </div>
                <div class="uix-files">
                    <a href="#"><img src="../../img/folder.webp" alt="folder.webp" class="folder-img"></a>
                </div>
            </div>
        </main>
    </script>
